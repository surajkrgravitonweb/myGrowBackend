    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(blank=True, decimal_places=2, max_digits=733, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profit', models.CharField(max_length=100)),
                ('buy_quantity', models.IntegerField(blank=True, max_length=50, null=True)),
                ('sell_quantity', models.IntegerField(blank=True, max_length=50, null=True)),
                ('loss', models.CharField(max_length=50)),
                ('user_email', models.CharField(max_length=100)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(blank=True, decimal_places=2, max_digits=7444, null=True)),
            ],
        ),
    ]
